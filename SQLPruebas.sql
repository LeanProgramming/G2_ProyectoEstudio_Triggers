...
/* Verificar que el mode de recuperación de la base de datos este en el modo adecuado para realizar backup en linea */
------------------------------------------------------------------------------------------------------
...
Set @DireccionCarpeta = 'C:\\Backup\ ' + @Fecha + '.bak'
...
Declare @DireccionCarpeta Varchar(400)
Set @DireccionCarpeta = 'C:\\Backup\  ' + @Fecha + '.trn'
...
---------------------------------------------------------------------------
/* Realizar nuevamente backup de archivo de log  en otro archivo fisico. */
---------------------------------------------------------------------------
...
DECLARE @Ubicacion NVARCHAR(128);
SET @Ubicacion = ''	--Aca va el nombre del archivo que se quiere realizar la restauración 
